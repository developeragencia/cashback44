...
export default function AdminUsers() {
  ...
  // Query para buscar usuários com saldos automáticos
  const { data, isLoading, refetch } = useQuery({
    ...
    queryFn: async () => {
      ...
      if (filterType && filterType !== 'all') {
        params.append('userType', filterType);
      }
      
      if (filterStatus && filterStatus !== 'all') {
        params.append('userStatus', filterStatus);
      }
      
      params.append('page', currentPage.toString());
      params.append('pageSize', '100'); // Aumentar para mostrar todos os usuários
