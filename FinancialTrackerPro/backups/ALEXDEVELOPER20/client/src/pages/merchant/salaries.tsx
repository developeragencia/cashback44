        ...
        <TabsContent value="earnings">
          <div className="grid md:grid-cols-4 gap-4 mb-6">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatCurrency(data?.earnings.totalSales || 0)}
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">
                  {formatCurrency(data?.earnings.totalCommissions || 0)}
                </div>
                <div className="text-sm text-muted-foreground mt-1">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-orange-600">
                  {formatCurrency(data?.earnings.platformFee || 0)}
                </div>
                <div className="text-sm text-muted-foreground mt-1">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatCurrency(data?.earnings.netEarnings || 0)}
                </div>
                <div className="text-sm text-muted-foreground mt-1">
              ...
              <CardContent>
                <div className="mb-6">
                  ...
                  <div className="text-3xl font-bold">
                    {formatCurrency(data?.earnings.pendingPayouts || 0)}
                  </div>
                </div>
