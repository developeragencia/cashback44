    ...
    async function loadUser() {
      try {
        ...
        if (response.ok) {
          ...
          // Não redirecionamos se estivermos em uma página de convite
          if (!isInvitePage) {
            console.log('Não está em página de convite, redirecionando para login');
            navigate('/auth/login');
          } else {
            console.log('Em página de convite, ignorando redirecionamento');
          }
