...
export function Sidebar({ 
  ...
  const merchantLinks = [
    ...
    { href: "/merchant/withdrawals", icon: <Landmark className="mr-2 h-5 w-5" />, label: t('merchant.requestWithdrawal') },
    { href: "/merchant/salaries", icon: <DollarSign className="mr-2 h-5 w-5" />, label: "Comissões e Taxas" },
    ...
    { href: "/merchant/stores", icon: <Store className="mr-2 h-5 w-5" />, label: t('merchant.partnerStores') },
  ...
  const adminLinks = [
    ...
    { href: "/admin/withdrawals", icon: <CreditCard className="mr-2 h-5 w-5" />, label: t('navigation.withdrawals') },
